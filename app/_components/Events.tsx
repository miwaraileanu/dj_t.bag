...
const Events = () => {
    return (
        <div id='events' className='peralta-font products w-full h-auto  bg-white flex flex-col justify-between items-center my-[5%]'>

            <div className="text flex flex-col justify-between items-center w-[80%] h-auto my-[3%]">
                <h1 className=' uppercase mb-3 text-[8vh]'>Everything we can help you with</h1>
            </div>
            {/* Event list */}
