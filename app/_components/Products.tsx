...
export default function ProductsList() {
    return (
        <div id='products' className="peralta-font products w-full h-[100vh]  bg-white flex flex-col justify-between items-center my-[3%]">
            ...
            <Link href="/products" className='flex items-center justify-center'>
              <button className="text-[2vh] md:text-[3vh] backdrop-blur-lg hover:textblack text-black block underline">
                Find More
              </button> 
            </Link>
            </div>
